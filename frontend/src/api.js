...
// Inject the current client_id on every outgoing request so the backend
// can scope results to the logged-in user's dataset.
smartApi.interceptors.request.use((config) => {
